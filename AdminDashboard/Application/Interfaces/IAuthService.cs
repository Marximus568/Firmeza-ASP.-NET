...
public interface IAuthService
{
    ...
    /// </summary>
    /// <param name="client">The domain client entity to register.</param>
    ...
    Task<AuthResultDto> RegisterAsync(Client client, string password, CancellationToken cancellationToken = default);
